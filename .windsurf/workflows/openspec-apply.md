...
- Review `openspec/docstring_rules.md` and apply the Docstring First gate before touching code.

**Steps**
Track these steps as TODOs and complete them one by one.
1. Read `changes/<id>/proposal.md`, `design.md` (if present), and `tasks.md` to confirm scope and acceptance criteria.
2. Before modifying code, refresh docstrings per `openspec/AGENTS.md` and the detailed guidance in `openspec/docstring_rules.md`, ensuring Notes reference the governing spec.

...
class TestConfigDataPipeline:
    ...
    def test_config_building_integration(self, temp_dir):
        ...
        model_config = {"name": "test_model", "backbone": "resnet18", "num_classes": 10}

        training_config = {"learning_rate": 0.001, "epochs": 5, "batch_size": 4}
...
class TestModelConfigIntegration:
    ...
    def test_training_config_integration(self):
        ...
        try:
            ...
            assert hasattr(training_config, "batch_size") or hasattr(
